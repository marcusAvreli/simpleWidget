...
import simpleWidget.widget.CustomApplicationView;
import simpleWidget.widget.SwingBuilderView;
...
@Views({
	...
	@View(type=CustomApplicationView.class,position=PerspectiveConstraint.RIGHT)
})
